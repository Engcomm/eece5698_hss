...
//        printf("Time: %i\n", *timing);
    ...
    if (*timing < threshold) 
    {
        fwrite(ciphertext, sizeof(uint8_t), 16, cipherOutFP);
    }
}
bool loadTrace()
{
...
void init()
{
    ...
    cipherOutFP = fopen(cipherOutFileName, "w");
    resetCounter();
}
void finish()
{
